...
<div className="flex flex-col justify-center items-center">
         <div className="w-[350px] sm:w-[500px] md:w-[600px] ">
          ...
          <div className="flex flex-col px-6 font-semibold  pl-12 pt-3  font-serif ">
                 <h2 className="flex items-center gap-x-2"> <span className="text-xl"><ImLocation/></span>  Alara Street, Off Ekerin Road, Ologuneru Area, Ibadan.</h2>
                  <h2 className="flex items-center gap-x-2 py-4"> <span className="text-xl"><BsFillTelephoneInboundFill/></span>  08139116879 </h2>
                  <h2 className="flex items-center gap-x-2"> <span className="text-xl"><MdEmail/></span> bellooladimeji53@gmail.com</h2>
          </div> 
          <h1 className="flex items-center px-6 justify-center  gap-x-3 pt-[50px]
           text-2xl font-bold"><span className="text-3xl"><AiFillBank/></span>Bank Details</h1> 
             <div className="flex flex-col pl-12 pt-3 font-semibold font-serif " >
                  ...
                  <h2>Bank Name : GT Bank</h2>
                  <h2>Account Name: Bello Muhyideen</h2>
                  <h2>Account Number:0430639329 </h2>
           </div>
